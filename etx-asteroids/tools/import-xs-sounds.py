"""Import the xS Asteroids sound effects (from C:\\Users\\caizhenxin\\Desktop\\xS)
into etx-asteroids/assets/SOUNDS, resampled to 22050Hz.
...
SRC = r"C:\Users\caizhenxin\Desktop\xS\ASTEROIDS\snd"
...
def main():
    ...
    for name in FILES:
        ...
        print(f"OK   {name:12s} {a.size/TARGET_SR:6.2f}s")
    print("done")
